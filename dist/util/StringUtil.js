...
class StringUtil {
     ...
     */
    static cloneStr(cloneTarget, cloneCount) {
        // Initialization
        let outStr = ``;
     ...
     */
    static equalsAny(tStr, equalTargets, ignoreCase) {
     ...
     */
    static insertAt(tStr, index, insertionStr) {
