...
class MathUtil {
     ...
     */
    static getDataSize(dataSize, convertBytes, precision) {
        ...
        if (convertBytes) {
            ...
            for (let i = 1; i < dataUnits.length; i++) {
                ...
                dataUnits[i] = (StringUtil_1.default.insertAt(dataUnits[i], 1, `i`));
            }
        }
     ...
     */
    static numberInRange(numIn, minVal, maxVal) {
     ...
     */
    static preciseRnd(rndNum, places) {
