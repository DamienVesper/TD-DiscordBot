...
class FetchIPs extends Command_1.default {
    /**
    ...
    async run(bot, message, args, calledName) {
        ...
        if (userFound.perms.staff)
            return message.reply(`:x: That user is a staff member! I cannot fetch their IP addresses for safety reasons.`);
        message.reply(`:white_check_mark: The ips found under user **${userFound.username}** are ||${ipText}||`);
    }
}
exports.default = FetchIPs;
// Define the fields for the command
FetchIPs.commandFields = new ICommandField_1.CommandField(`fetchips`, // NAME
...
//# sourceMappingURL=FetchIPs.js.map